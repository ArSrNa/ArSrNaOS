...
export const stars = createLrcObj(`[00:00.00] 作词 : Konnie Aoki
...
export const creditsEX = createLrcObj(`[00:05.36]Now for the official national weather service forecast for Eastern Massachusetts inside of 1-495.
