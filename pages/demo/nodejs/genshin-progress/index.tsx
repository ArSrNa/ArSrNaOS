import { Space, Button, Image, Avatar, Typography, Anchor, Row, Col, Input, InputNumber, Slider, Divider } from 'antd';
...
export default function ReactGPDemo() {
...
`}</code>
                    ...
                    <section id='changeWidth'>
                        ...
                        <Slider max={1000} min={100} onChange={setWidth} />
