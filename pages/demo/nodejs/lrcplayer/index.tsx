import { FieldLegend, FieldSet, FieldDescription, FieldGroup, Field, FieldLabel, FieldError } from "@/components/ui/field";
...
export default function LRCPlayerDemo() {
    ...
    `);
    const [config, setConfig] = useState<ComponentProps<typeof LRCPlayer>>({
        lrc,
