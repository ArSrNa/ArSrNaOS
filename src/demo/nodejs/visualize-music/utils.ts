...
export const characters = [{
    name: '荧', cv: '宴宁', img: Lumine, color: '#EEDCA2'
}, {
    name: '茜特菈莉', cv: '柳知萧', img: Citlali, color: '#B986AE'
}, {
    name: '丝柯克', cv: '谢莹', img: Skirk, color: '#2B3882'
}, {
    name: '嘉明', cv: '谢莹', img: Gaming, color: '#611E10'
}, {
    name: '胡桃', cv: '陶典', img: Hutao, color: '#ECB79A'
}, {
    name: '蒂莱尔', cv: '闫夜桥', img: Direidyth, color: '#253B64'
}, {
    name: '凯亚', cv: '孙晔', img: Kaeya, color: '#456886'
}];
